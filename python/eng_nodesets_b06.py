...
# Examines time-sliced Echonest 'Omega Year' genre lists
...
omegaGenrePath = os.path.join("data", omegaYear, "genres")
fileNames = os.listdir(omegaGenrePath)

# open files for data output
intersectDataPath = os.path.join("data", omegaYear, omegaYear + '_genre_intersects.txt')
intersectData = open(intersectDataPath, 'w')

# Data file for weighted, undirected graph
wuGraphDataPath = os.path.join("data", omegaYear, omegaYear + '_wuGraph_data.txt')
wuGraphData = open(wuGraphDataPath, 'w')

# open file for writing log
logPath = os.path.join("logs", 'eng_nodesets_' + versionNumber + '_' + omegaYear + '_log.txt')
