...
logPath = os.path.join("logs", 'nhm_line_plotter_' + versionNumber + '_log.txt')
runLog = open(logPath, 'a')

# define paths for graphs
#graphHPath = os.path.join("graphs", 'nhm_plotter_' + versionNumber + ".eps")
nodeHPath = os.path.join("graphs", 'nhm_h_line_plot_' + versionNumber + ".eps")
graphPercPath = os.path.join("graphs", 'nhm_p_line_plot_' + versionNumber + ".eps")
...
# ..and begin..
runLog.write ('\n' + 'Network Hybridity Metric Line Plotter - Beta | ' + 'Version: ' + versionNumber + '\n' + '\n')
print ('\n' + 'Network Hybridity Metric Line Plotter - Beta | ' + 'Version: ' + versionNumber + ' | Starting' + '\n' +'\n')
